  ...
  return (
    <nav className='fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-2 py-3'>
      <div className='flex justify-around items-center'>
        ...
        <Link href="/Product" className='flex-1 flex flex-col items-center gap-1 p-2 rounded-lg hover:bg-gray-50 transition'>
          <Package size={20} className='text-gray-600' />
          <span className='text-xs font-light text-gray-600'>Produk</span>
        </Link>
